...
DOBBY connects to your Apple Calendar, Mail, and Notes. It can browse the web, spawn Claude Code sessions to build entire projects, and plan your day -- all through natural voice conversation.

> "Will do, sir."

<!-- TODO: Add demo GIF or screenshot here -->
<!-- ![DOBBY Demo](docs/demo.gif) -->

---

## What It Does

- **Voice conversation** -- speak naturally, get spoken responses with a DOBBY voice
...
- **Audio-reactive orb** -- a Three.js particle visualization that pulses with DOBBY's voice
...
Click the page once to enable audio, then speak. DOBBY will respond.
...
# Optional -- your name (DOBBY will address you personally)
USER_NAME=Tony
...
| TTS | Fish Audio with DOBBY voice model |
...
4. DOBBY detects intent -- conversation, action, or build request
...
7. Fish Audio converts the response to speech with the DOBBY voice
...
### Action System
DOBBY uses action tags to trigger real system actions:
...
### Memory System
DOBBY remembers things you tell it using SQLite with FTS5 full-text search. Preferences, decisions, and facts persist across sessions.
...
Inspired by the AI that started it all -- Tony Stark's DOBBY.

> **Disclaimer:** This is an independent fan project and is not affiliated with, endorsed by, or connected to Marvel Entertainment, The Walt Disney Company, or any related entities. The DOBBY name and character are property of Marvel Entertainment.
