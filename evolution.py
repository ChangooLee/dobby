"""
DOBBY Template Evolution — Analyzes failures and generates improved template versions.
...
log = logging.getLogger("dobby.evolution")

TEMPLATES_DIR = Path(__file__).parent / "templates" / "prompts"
DB_PATH = Path(__file__).parent / "dobby_data.db"
