"""
DOBBY Memory & Planning — persistent context, tasks, notes, and smart routing.

Three systems:
1. Memory — facts, preferences, project context DOBBY learns from conversations
...
so DOBBY gets smarter over time.
"""
...
log = logging.getLogger("dobby.memory")

DB_PATH = Path(__file__).parent / "data" / "dobby.db"
...
async def extract_memories(user_text: str, dobby_response: str, anthropic_client) -> list[str]:
