"""
DOBBY Proactive Suggestions — Contextual follow-up suggestions after task completion.
...
log = logging.getLogger("dobby.suggestions")
...
class Suggestion:
    ...
    text: str  # Voice-friendly suggestion (DOBBY personality)
