"""
DOBBY Browser — Playwright-based web browsing capabilities.
...
log = logging.getLogger("dobby.browser")
...
class DobbyBrowser:
    """Playwright-based web browsing for DOBBY."""
    ...
    async def _ensure_browser(self):
        ...
        # Launch VISIBLE browser so user can watch DOBBY browse
    ...
    async def screenshot(self, url: str, path: str = None) -> str:
        ...
        try:
            ...
            if not path:
                tmp = tempfile.mktemp(suffix=".png", prefix="dobby_screenshot_")
                path = tmp
