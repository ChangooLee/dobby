"""
DOBBY Dispatch Registry — tracks all active and recent project builds/dispatches.

Persists to SQLite so DOBBY always knows what he's working on,
...
log = logging.getLogger("dobby.dispatch")
