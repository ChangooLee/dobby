# DOBBY — Voice AI Assistant

## Overview
DOBBY (Just A Rather Very Intelligent System) is a voice-first AI assistant for macOS. It runs locally on your machine, connecting to your Apple Calendar, Mail, Notes, and can spawn Claude Code sessions for development tasks.
...
10. Click to enable audio, speak to DOBBY
...
- `USER_NAME` (optional) — Your name for DOBBY to use
- `CALENDAR_ACCOUNTS` (optional) — Comma-separated calendar emails

## Conventions
- DOBBY personality: British butler, dry wit, economy of language
